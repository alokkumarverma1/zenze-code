...
const reviews = [
  ...
  },
  {
    ...
    <Navbar></Navbar>
    {/* hero section  */}
 <div ref={box} className="home overflow-hidden shadow-md  bg-gradient-to-br from-cyan-200 via-sky-50 to-indigo-300  rounded-b-4xl   flex justify-center items-center w-full flex-col text-center  h-screen">
    <div className="sm:w-[70%] w-full h-full flex sm:pr-5 sm:pl-5 p-3 flex-col justify-center items-center text-center">
          <h1 className="letter font-bold lg:text-9xl sm:text-3xl text-4xl ">ZenZe Code</h1>  
    ...
    {/* animation card */}
 <div className="animation-card z-30 h-56 sm:h-80 w-full flex justify-center items-center">
  <div className="center w-24 sm:w-40 h-[90%]  relative">

    <div className="card1 h-full bg-white w-full rounded-2xl shadow-xl shadow-gray-300 border border-gray-200 absolute bottom-0 flex flex-col items-center text-center p-2 sm:p-4">
      ...
      <h1 className="text-xs sm:text-[15px] font-semibold mt-2">Learn basic to advance</h1>
    ...
    <div className="card2 h-full w-full rounded-2xl shadow-xl shadow-gray-300 border border-gray-200 absolute bottom-0 flex flex-col bg-white items-center text-center p-2 sm:p-4">
      ...
      <h1 className="text-xs sm:text-[15px] font-semibold mt-2"> Get your dream jobs now</h1>
    ...
    <div className="card3 bg-white h-full w-full rounded-2xl shadow-xl shadow-gray-300 border border-gray-200 absolute bottom-0 flex flex-col items-center text-center p-2 sm:p-4">
      ...
      <h1 className="text-xs sm:text-[15px] font-semibold mt-2">Build real world projects</h1>
 ...
 <div className="first w-full sm:w-[80%] min-h-24 flex flex-col sm:flex-row items-center gap-3 sm:gap-6 p-4 rounded-2xl shadow-lg border border-gray-200 bg-white">
  ...
  <p className="text-sm sm:text-base text-gray-600 leading-relaxed">Learn your favorite and most in-demand programming languages from beginner to advanced level, including Java, JavaScript, Python, C++, React, and many more through structured lessons and hands-on practice.</p>
 </div>
...
<div className="first w-full sm:w-[80%] min-h-24 flex flex-col sm:flex-row items-center gap-3 sm:gap-6 p-4 rounded-2xl shadow-lg border border-gray-200 bg-white">
  <div className="round h-14 w-20 sm:h-16 sm:w-20 rounded-full flex justify-center items-center bg-gradient-to-br from-emerald-400 via-green-500 to-teal-500 shadow-lg">
    ...
    <p className="text-sm sm:text-base text-gray-600 leading-relaxed">Build real-world projects from beginner to advanced level and gain practical experience by creating professional applications that strengthen your portfolio and prepare you for internships and jobs.</p>
</div>
 ...
 <div className="first w-full sm:w-[80%] min-h-24 flex flex-col sm:flex-row items-center gap-3 sm:gap-6 p-4 rounded-2xl shadow-lg border border-gray-200 bg-white">
  ...
  <p className="text-sm sm:text-base text-gray-600 leading-relaxed"> Prepare for internships and high-paying tech jobs with industry-focused learning paths, interview preparation, coding challenges, resume guidance, and career-focused projects.</p>
</div>
  ...
  <div className="flex justify-center mt-10 items-center flex-col text-center p-3 sm:pr-10 sm:pl-10">
   <h1 className="font-bold sm:text-3xl text-2xl"><span className="bg-gradient-to-br from-cyan-500 via-sky-300 to-indigo-500 bg-clip-text text-transparent">Popular</span> courses</h1>
 </div>

  <div className="course w-full mb-10 mt-10 min-h-50 flex flex-wrap justify-center gap-10 items-center" >
<div className="c-card h-40  bg-gradient-to-br from-cyan-50 via-sky-50 to-indigo-100 w-60 rounded-2xl p-3 shadow text-center">
...
<div className="flex justify-center items-center flex-col text-center p-3 sm:pr-10 sm:pl-10">
   <h1 className="font-bold sm:text-3xl text-2xl bg-gradient-to-br from-cyan-500 via-sky-300 to-indigo-500 bg-clip-text text-transparent">Earn a Certificate That</h1>
...
<div className="certificate mb-10 w-full min-h-100 gap-10 flex sm:flex-row flex-col justify-around items-center">
    ...
    <div className="leftimag sm:h-60 sm:w-90 h-40 w-50 rounded-2xl bg-gray-200">
    <img src="certificate.png" alt="" className="w-full h-full" />
    </div>
  ...
  <div className="first p-4 border sm:flex-row flex-col border-gray-200 rounded-2xl flex gap-4 hover:shadow-lg transition-all">
    <div className="round bg-green-100 rounded-2xl h-12 w-12 flex justify-center items-center">
     ...
     <div>
      <h1 className="font-bold text-lg">Industry-Ready Recognition</h1>
      <p className="text-gray-600 text-sm mt-1">Demonstrate your practical skills and real-world project experiencewith a professional certificate.</p>
     </div>
  </div>
  ...
  <div className="first p-4 border sm:flex-row flex-col border-gray-200 rounded-2xl flex gap-4 hover:shadow-lg transition-all">
    ...
    <div>
      <h1 className="font-bold text-lg">Boost Your Career Profile</h1>
      <p className="text-gray-600 text-sm mt-1">Add your certificate to resumes, portfolios, and professionalnetworking platforms.</p>
    </div>
  </div>
  ...
  <div className="first p-4 border border-gray-200 rounded-2xl flex sm:flex-row flex-col gap-4 hover:shadow-lg transition-all">
    ...
    <div>
      <h1 className="font-bold text-lg">Proof of Achievement</h1>
      <p className="text-gray-600 text-sm mt-1">Showcase your dedication, learning progress, and successful coursecompletion with confidence.</p>
    </div>
  </div>
